...
public struct PublisherSingle: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int? = nil, name: String, slug: String? = nil, gamesCount: Int? = nil, imageBackground: String? = nil, description: String? = nil) {
        self.id = id
        self.name = name
        self.slug = slug
